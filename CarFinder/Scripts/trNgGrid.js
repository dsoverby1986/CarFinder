    ...
    */
    ...
    var GridController = (function () {
        ...
        GridController.prototype.setupDataFormattingTriggers = function (gridScope) {
            ...
            gridScope.$watch(watchExpression, function () {
                return _this.scheduleDataFormatting();
            }, true);
        };
        ...
        GridController.prototype.setupServerSideModeTriggers = function (gridScope) {
            ...
            gridScope.speedUpAsyncDataRetrieval = function ($event) {
                return _this.speedUpServerSideModeDataRetrieval($event);
            };
        };
        ...
        function () {
            var setupColumnTitle = function (scope) {
                if (scope.columnOptions.displayName) {
                    ...
                    var rawTitle = scope.columnOptions.fieldName.replace(/^([^\a-zA-Z]*)([\a-zA-Z]*)(.*)/g, "$2");
